from app.controller.schemas import ApplicationAuditTrailResponse
from typing import Dict
from app.controller.schemas import ApplicationCreation
...
from app.controller.schemas import ApplicationListData
from app.config import get_settings
from app.utils.i18n import get_request_locale, match_supported_locale, register_i18n, sanitize_next_url, translate
...
def _build_application_creation_payload(form_data: dict, owners: List[str]) -> dict:
    ...
    if client_type == "public":
        ...
        if client_auth_method and client_auth_method == "private_key_jwt" and jwks_uri_value:
            payload["providers"]["oidc"]["properties"]["additionalConfig"]["jwksUri"] = jwks_uri_value
